...
def process_task_accuracies(all_task_accuracies: dict[str, list[float]], epochs_per_task: int, permute_seeds: list[int]) -> tuple[float, float]:
    ...
    task0_acc_2 = all_task_accuracies['task_evaluation_acc']['training_42'][0][epochs_per_task-1]
    task42_acc_0 = all_task_accuracies['task_evaluation_acc']['training_0'][42][0]
    task42_acc_1 = all_task_accuracies['task_evaluation_acc']['training_0'][42][epochs_per_task-1]
